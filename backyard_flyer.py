...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        if self.flight_state == States.TAKEOFF:
            ...
            #That is the distance is withing 1 m 
            #Distanve between taraget and local position
            #print("local position", self.local_position[0:2])
            #land within 1m of the starting location
            #Calculate Distance 
    ...
    def calculate_box(self):
        ...
        #We have a 2D Matrix here

        waypoints = [ [5.0, 0.0, 3.0], # 5 meters north, 0 meters east maintain altidue 3 meters from ground
                      [5.0, 5.0, 3.0], # 5 meters north, 5 meters east maintain altidue 3 meters from ground
                      [0.0, 5.0, 3.0], # 0 meters north, 5 meters east maintain altidue 3 meters from ground
                      [0.0, 0.0, 3.0] 
                    ]
        return waypoints
        pass
